...
As the size of \rooplpp arrays is determined by a passed expression evaluation, it is unknown at compile time. This also means that out-of-bounds checking cannot be conducted during compilation. A possible solution for this is presented in section~\ref{sec:error-handling}.  
...
\begin{figure}[ht]
    ...
    \begin{tabular}{ c | c | c }
        ...
        Linked List & 61 & 1280 \\
        Doubly-Linked List & 66 & 1339 \\
        Binary Tree & 86 & 2056 \\ 
        RTM Simulation & 211 & 6716 \\ 
      \end{tabular}
